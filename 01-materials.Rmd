# Teaching materials for the book "Architecture for Blockchain Applications" {#materials}
...
Slide decks from the lectures of this course are available in the folder [Slides](https://github.com/ingo-weber/blockchain-architecture/tree/main/Slides).

## Practice exam

A practice exam and slides with correct or sample answers are available in the folder [Practice exam](https://github.com/ingo-weber/blockchain-architecture/tree/main/Practice_exam).
